        ...
        <div id="maindasboard">
            <div id="row1">
                <div id="TotalOrder">
                    ...
                    <span id="to"><FontAwesomeIcon icon={faArrowUpRightDots} />+ 16.24 %</span><br></br>
                    <label id="Ton">{orderCount}</label><br></br>
                    <label className="des">View all orders</label>
                    <span className="symbol"><FontAwesomeIcon icon={faStar} /></span>
                </div>
                <div id="TotalCustomer">
    <label>TOTAL CUSTOMERS</label>
    <span id="tc"><FontAwesomeIcon icon={faArrowUpRightDots} style={{ color: "red" }} /> - 2.3 %</span><br />
    <label id="Tcn">{customerCount}</label><br></br>
...
<div id="TotalEarning">
    ...
    <span id="te"><FontAwesomeIcon icon={faArrowUpRightDots} /> + 16.24 %</span><br />
    <label id="Ten">₹{totalEarnings.toLocaleString()}</label><br></br>
    <label className="des">View net earnings</label>
     <span className="symbol"><FontAwesomeIcon icon={faWallet} /></span>
</div>
<div id="FinalBalance">
    <label>FINAL BALANCE</label>
    <span id="fb"><FontAwesomeIcon icon={faArrowUpRightDots} style={{ color: "red" }} /> - 2.3 %</span><br />
    <label id="Fbn">$ 330M</label><br></br>
    <label className="des">See details</label>
     <span className="symbol"><FontAwesomeIcon icon={faWallet} /></span>
  ...
  <div className="list-header">
    <h3>Products List</h3>
    <div className="sort-by">Sort by: <strong>Last 7 Days</strong></div>
  </div>
  <table className="styled-table">
    <thead>
      <tr>
